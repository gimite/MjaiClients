...
public class TsumogiriClientMain {
    ...
    public static void main(String[] args) throws UnknownHostException, IOException {
        ...
        TsumogiriClient client = new TsumogiriClient(socket, objectMapper);
        client.run();
    }
}

class TsumogiriClient {
    ...
    public TsumogiriClient(Socket socket, ObjectMapper objectMapper) throws IOException {
